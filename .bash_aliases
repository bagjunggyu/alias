...
alias 업글='sudo apt-get update;sudo apt-get upgrade -y;sudo apt-get autoremove --purge -y'
alias djqrmf='sudo apt-get update;sudo apt-get upgrade -y;sudo apt-get autoremove --purge -y'
alias 업그리='sudo apt-get update;sudo apt-get dist-upgrade -y;sudo apt-get autoremove --purge -y'
alias djqrmfl='sudo apt-get update;sudo apt-get dist-upgrade -y;sudo apt-get autoremove --purge -y'
alias 닫기='exit'
alias ekerl='exit'
alias 정리='clear'
alias wjdfl='clear'
...
#alias bak='sudo mv /boot/burg/burg.cfg /boot/burg/burg.cfg.bak;sudo update-burg'
#alias burgmc='sudo update-grub;sudo update-burg;sudo nano /boot/burg/burg.cfg;sudo nano /boot/burg/burg.cfg.bak;sudo mv /boot/burg/burg.cfg.bak /boot/burg/burg.cfg;sudo cp /boot/burg/burg.cfg /boot/burg/burg.cfg.bak;sudo reboot'
