...
alias upgrade='sudo apt-get update;sudo apt-get upgrade -y;sudo apt-get autoremove --purge -y;sudo apt-get autoclean clean -y'
alias d-upgrade='sudo apt-get update;sudo apt-get dist-upgrade -y;sudo apt-get autoremove --purge -y;sudo apt-get autoclean clean -y'
...
alias pak='dpkg -l | grep'
alias dlm='dpkg -l | grep linux-image'
alias dlh='dpkg -l | grep linux-headers'
